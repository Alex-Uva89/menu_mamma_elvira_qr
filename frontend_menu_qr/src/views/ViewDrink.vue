<template>
    <div>
      ...
      <div class="dish-info">
        ...
        <p v-if="dish.instructions" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Ingredienti</p>
        <span v-if="dish.instructions">{{ dish.instructions }}</span>
        <p v-if="dish.degrees" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Gradi</p>
        <span v-if="dish.degrees">{{ dish.degrees }}</span>
        <p v-if="dish.origin" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Origine</p>
        <span v-if="dish.origin">{{ dish.origin }}</span>
        <p v-if="dish.color" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Colore</p>
        <span v-if="dish.color">{{ dish.color }}</span>
        <p v-if="dish.production_method" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Metodo di produzione</p>
        <span v-if="dish.production_method">{{ dish.production_method }}</span>
        <p v-if="dish.flavour" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Gusto</p>
        <span v-if="dish.flavour">{{ dish.flavour }}</span>
        <p v-if="dish.producer" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Produttore</p>
        <span v-if="dish.producer">{{ dish.producer }}</span>
        <p v-if="dish.grape_variety" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Vitigno</p>
        <span v-if="dish.grape_variety">{{ dish.grape_variety }}</span>
        <p v-if="dish.denomination" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Denominazione</p>
        <span v-if="dish.denomination">{{ dish.denomination }}</span>
        <p v-if="dish.vintage" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Annata</p>
        <span v-if="dish.vintage">{{ dish.vintage }}</span>
        <p v-if="dish.breeding_method" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Metodo di allevamento</p>
        <span v-if="dish.breeding_method">{{ dish.breeding_method }}</span>
        <p v-if="dish.format" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Formato</p>
        <span v-if="dish.format">{{ dish.format }}</span>
        <p v-if="dish.serving_temperature" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Temperatura di servizio</p>
        <span v-if="dish.serving_temperature">{{ dish.serving_temperature }}</span>
        <p v-if="dish.nose" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Olfatto</p>
        <span v-if="dish.nose">{{ dish.nose }}</span>
        <p v-if="dish.certifitations" :style="{ background: `var(--nav-${venueName.replace(/\s+/g, '-').replace(/,/g, '').replace(/'/g, '')})` }">Certificazioni</p>
