      ...
      <div class="dish-list-container">
        <div class="dish-list-item">
          ...
          <div v-else-if="isDrink && isWine && dish.price >= 100" class="dish-list-item-price-drink minim">
            <div>
              <img src="https://img.icons8.com/ios-filled/50/wine.png" alt="wine" class="icon"/> {{ dish.price }} | <img width="50" height="50" src="https://img.icons8.com/glyph-neue/64/shopping-bag--v1.png" alt="shopping-bag" class="icon"/> {{ dish.price - ( Math.ceil(dish.price / 4 + 50)) }}
            </div>
            <div>vino non disponibile al calice</div>
          </div>
